  ...
  <{tag}>
    ...
    <choice correct="false" name="foil4">This is <b>foil</b> Four.</choice>
        ...
        expected = {
            ...
            "choices": [
                ("foil1", "<text>This is foil One.</text>"),
...
class JSInputTest(unittest.TestCase):
    ...
    def _render_context_test(self, xml_str, expected_context):
        ...
        """
        element = etree.fromstring(xml_str)
        state = {"value": 103, "response_data": RESPONSE_DATA}
...
class TextLineTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        state = {"value": "BumbleBee", "response_data": RESPONSE_DATA}
...
class SchematicTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        state = {"value": value, "status": "unsubmitted", "response_data": RESPONSE_DATA}
...
class ChemicalEquationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        state = {"value": "H2OYeah", "response_data": RESPONSE_DATA}
    ...
    def test_ajax_parse_err(self):
        ...
        with patch("xmodule.capa.inputtypes.chemcalc.render_to_html") as mock_render:
            ...
            response = self.the_input.handle_ajax("preview_chemcalc", {"formula": "H2O + invalid chemistry"})
    ...
    def test_ajax_other_err(self, mock_log):
        ...
        with patch("xmodule.capa.inputtypes.chemcalc.render_to_html") as mock_render:
            ...
            response = self.the_input.handle_ajax("preview_chemcalc", {"formula": "H2O + superterrible chemistry"})
        mock_log.warning.assert_called_once_with("Error while previewing chemical formula", exc_info=True)
        assert "error" in response
...
class FormulaEquationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        state = {"value": "x^2+1/2", "response_data": RESPONSE_DATA}
    ...
    def test_ajax_other_err(self, mock_log):
        ...
        mock_log.warning.assert_called_once_with("Error while previewing formula", exc_info=True)
        assert "error" in response
        assert response["error"] == "Error while rendering preview"
...
"""
        ...
        state = {"value": json_value, "id": "annotation_input", "status": "answered", "response_data": RESPONSE_DATA}
